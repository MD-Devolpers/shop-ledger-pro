...
import { TrendingUp, TrendingDown, Sparkles, Wallet, CreditCard, Download, CalendarDays, Calendar } from "lucide-react";
...
export default function Reports() {
  const [reportTab, setReportTab] = useState<"report" | "monthly-profit">("report");
      ...
      <div className="flex-1 overflow-auto p-4">
        <Tabs value={reportTab} onValueChange={(v) => setReportTab(v as typeof reportTab)}>
          <TabsList className="w-full mb-4 grid grid-cols-2">
            ...
            <TabsTrigger value="monthly-profit">
