...
const features = [
  ...
  },
  {
    ...
    desc: "Add your products, track stock levels, and get notified when items are running low.",
  },
  {
    icon: Tag,
    color: "bg-orange-100 text-orange-600",
    title: "Product & Stock Tracking",
    desc: "Know exactly what's in your shop at any time. Update quantities as you buy and sell.",
  },
  {
    icon: AlertTriangle,
    color: "bg-yellow-100 text-yellow-600",
    title: "Low Stock Alerts",
    desc: "Never run out of popular items. Get instant alerts when stock drops below your set limit.",
  },
  {
    icon: BarChart3,
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-primary/5 via-background to-background px-4 pt-16 pb-20 text-center">
        <div className="max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 bg-primary/10 text-primary rounded-full px-4 py-1.5 text-xs font-semibold mb-6">
            ...
            Free for small shops — shop-ledger.online
          </div>
      ...
      <footer className="border-t bg-muted/30 px-4 py-8">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6 text-sm text-muted-foreground">
          ...
          <div className="text-center sm:text-right">
            <p>© {new Date().getFullYear()} Ledger Entries. All rights reserved.</p>
            <p className="text-xs mt-1">
              Developed by{" "}
              <a
                href="https://noirnode.com"
                target="_blank"
                rel="noopener noreferrer"
