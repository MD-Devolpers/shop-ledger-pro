// Note: @google-cloud/storage File type is used as 'any' here so this module
// does not statically import the package — allowing the server to start on
// environments where the package is not installed (e.g. Hostinger).
